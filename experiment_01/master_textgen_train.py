...
param.add_argument('-epoch', default=100)
...
# Introduction
print '\n'
print 'Welcome to the 1st Experiment --- Text Generator Model Training'
print '-------------------------------------------------------------------------'
...
print '[INFO] Converting to lower case...'
...
print '[INFO] Reshaping input samples...'
...
# Normalizing
print '[INFO] Normalizing input samples...'
...
print '[INFO] Creating one hot vector for output samples...'
...
model.load_weights('model_for_testing/master-3types-1l256u12-0.7492.hdf5')


# define the checkpoint
filepath="models/master-3types-1l256u-next2-{epoch:02d}-{loss:.4f}.hdf5"
...
model.load_weights('model_for_testing/master-3types100s-2l256u-34-0.3416.hdf5')


filepath="models/master-3types100s-2l256u-next1{epoch:02d}-{loss:.4f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='loss', verbose=1, save_best_only=True, mode='min')
callbacks_list = [checkpoint]
